...
In addition to this, we also investigated the most common interests reported by students as well as by classes taken. From this analysis, we created the following 2 plots:

![](images/Interests Counts-01.png)
...
|                                             |                                          |
|---------------------------------------------|------------------------------------------|
| ![](images/Proficiency across Total-01.png) | ![](images/Proficiency Across UD-01.png) |
...
|                                     |                                    |                                 |
|-------------------------------------|------------------------------------|---------------------------------|
| ![](images/Programming Comfort.png) | ![](images/Statistics Comfort.png) | ![](images/Math Comfort-01.png) |

|                           |                              |                           |
|---------------------------|------------------------------|---------------------------|
| ![](images/Prog Prof.png) | ![](images/Stat Prof-01.png) | ![](images/Math Prof.png) |
...
|                                 |                                 |                                 |
|---------------------------------|---------------------------------|---------------------------------|
| ![](images/Prog Comparison.png) | ![](images/Stat Comparison.png) | ![](images/Math Comparison.png) |
